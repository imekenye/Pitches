...
This is a Python Web app that allows users to publish pitches.

## Author name

[Isaiah mekenye](https://github.com)

## Project Description

This is an app that allows users to view and write pitches from different categories.
...
| User logins | once user is authenticated profile is displayed|
| User clicks on submit pitch | Pitch form is displayed|
